...
[Component,Status,Message,RecommendedAction] = appendHealthRow( ...
    Component,Status,Message,RecommendedAction,"Pipeline version","INFO", ...
    sprintf('v%s, build %s',VersionInfo.Version,VersionInfo.BuildTimestamp), ...
    "No action needed.");
...
Result.PipelineVersion = VersionInfo;
