...
report=struct('Dandiset','000891','Version','0.240215.0831', ...
    ...
    'LabelsAvailable',false,'Mouse','ID400','Genotype','WT','Condition','Awake_immobile', ...
    'DrugID','awake','Promoter','GFAP.PHP','Status','converted', ...
...
C=struct('SFs',rate,'PiSz',4.75,'Mous','ID400','Cond','Awake_immobile', ...
    'Drug','awake','Gen','WT','Promo','GFAP.PHP','Puff',NaN,'strOW','Y');
started=tic;
try
    ...
    Mouse={'ID400'};Genotype={'WT'};Condition={'Awake_immobile'};
