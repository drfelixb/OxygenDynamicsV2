...
[Names,Values] = addMetric(Names,Values,'Burden_Occupancy_Sum', ...
    tableColumnSum(RecordingTable,'Burden_Occupancy'));
[Names,Values] = addMetric(Names,Values,'Burden_RankAmplitude_Sum', ...
    tableColumnSum(RecordingTable,'Burden_RankAmplitude'));
[Names,Values] = addMetric(Names,Values,'Burden_AmplitudeComposite_Sum', ...
    tableColumnSum(RecordingTable,'Burden_AmplitudeComposite'));
