...
Summary=table('Size',[0 9],'VariableTypes', ...
    ...
    'ValidBaselineFraction','FiniteAmplitudeFraction'});
...
for k=1:2
    ...
    for r=1:numel(ids)
        ...
        T=E(rows,:);n=height(T);valid=0;finite=0;wrong=0;
        if n>0
        ...
        Summary(end+1,:)={ids(r),kinds(k),n,valid,finite,n-finite,wrong, ...
            valid/denom,finite/denom}; %#ok<AGROW>
    end
end
end
