...
RecordingTemplate = struct( ...
    ...
    'ImagingStatus','Not run','AmyloidFile','','AmyloidStatus','Not run', ...
    'AmyloidOutputFolder','','BehaviourStatus','Not run');

WrapperRunInfo = struct();
WrapperRunInfo.PipelineVersion = getOxygenPipelineVersion();
