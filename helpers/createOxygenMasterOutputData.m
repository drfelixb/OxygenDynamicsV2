function OutputData = createOxygenMasterOutputData(recordingFolder,overwriteOutputs,datafileID,analysisInfo, ...
...
%CREATEOXYGENMASTEROUTPUTDATA Package oxygen master outputs for the save helper.
...
OutputData.Table_OxygenSinkEvents_Out = Table_OxygenSinkEvents_Out;
OutputData.OxySinkArea_all = OxySinkArea_all;
OutputData.Mean_ROI_TraceZ = Mean_ROI_TraceZ;
OutputData.Mean_OxySink_TraceZ = Mean_OxySink_TraceZ;
OutputData.Mean_OxySink_Trace_Convo = Mean_OxySink_Trace_Convo;
OutputData.Mean_OxySink_Trace_Raw = Mean_OxySink_Trace_Raw;
...
OutputData.Table_OxygenSurgeEvents_Out = Table_OxygenSurgeEvents_Out;
