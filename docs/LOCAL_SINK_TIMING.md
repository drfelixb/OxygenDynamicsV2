...
Current measurement identity is `event-footprint-surge-tracking-qc-5`; statistics identity is
`mouse-strict-tracking-qc-6` after the [close-run correction](SINK_RECURRENCE.md). Old and new saved analyses cannot be mixed. Reanalysis is
